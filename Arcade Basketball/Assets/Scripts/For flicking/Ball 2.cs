...
public class Ball2 : MonoBehaviour
{
    ...
    public void Launch(Vector3 releasePoint, float force, float angleInRadians)
    {
        isThrown = true;
        isSticking = false;
